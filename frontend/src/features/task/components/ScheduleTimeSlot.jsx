...
import { useAddGoogleAccountMutation } from '../../calendar/api/calendarApi'
import { useSyncTaskWithGoogleMutation } from '../api/taskApi'
import { setAlert } from '../../ui/alertSlice'
import { navigateCalendarToDate } from '../../calendar/calendarSlice'
...
const ScheduleTimeSlot = React.memo(({ slot, index }) => {
      ...
      const handleSyncWithGoogle = useCallback(
         async (accountEmail, calendarId) => {
            ...
            await syncTaskWithGoogle(reqData)
         },
